...
export VLN_ANNOTATION="${VLN_ANNOTATION:-/mnt/data/vmo-ai-task/anhdh35/JanusVLN/train_r2r.json}"
...
if [[ "$VLN_TRAIN_MODE" == "finetune" ]]; then
    ...
    OUTPUT_DIR="${OUTPUT_DIR:-/mnt/data/vmo-ai-task/dungpq6/model-checkpoint/spatialstack_ablation_fifth_r2r}"
fi
...
DATASETS="${DATASETS:-train_r2r%100}"
...
GEOMETRY_FUSION_LAYERS="${GEOMETRY_FUSION_LAYERS:-10 14 18}"
