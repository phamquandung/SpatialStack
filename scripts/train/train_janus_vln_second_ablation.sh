...
if [[ "$VLN_TRAIN_MODE" == "finetune" ]]; then
    ...
    OUTPUT_DIR="${OUTPUT_DIR:-/mnt/data/vmo-ai-task/dungpq6/model-checkpoint/spatialstack_ablation_second_r2r_rxr}"
fi
...
GEOMETRY_FUSION_LAYERS="${GEOMETRY_FUSION_LAYERS:-16 17 18}"
