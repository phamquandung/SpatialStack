...
if [[ "$VLN_TRAIN_MODE" == "finetune" ]]; then
    ...
    OUTPUT_DIR="${OUTPUT_DIR:-/mnt/data/vmo-ai-task/dungpq6/model-checkpoint/spatialstack_ablation_six_r2r}"
fi
...
GEOMETRY_FUSION_LAYERS="${GEOMETRY_FUSION_LAYERS:-22 26 30}"
