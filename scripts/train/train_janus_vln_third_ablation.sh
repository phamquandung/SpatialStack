...
if [[ "$VLN_TRAIN_MODE" == "finetune" ]]; then
    ...
    OUTPUT_DIR="${OUTPUT_DIR:-/mnt/data/vmo-ai-task/dungpq6/model-checkpoint/spatialstack_ablation_third_r2r}"
fi
...
GEOMETRY_FUSION_LAYERS="${GEOMETRY_FUSION_LAYERS:-28 29 30}"
